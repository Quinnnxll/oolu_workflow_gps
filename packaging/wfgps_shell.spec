# PyInstaller spec for the single-file Workflow-GPS shell app.
# Build with:  python packaging/build.py   (installs PyInstaller if needed)
# Output:      dist/WorkflowGPS-Shell (.exe on Windows)
#
...
# - workflow_gps's data files: the starter skill pack is read through
