...
from workflow_gps.billing.model_calls import ModelCallMeter
...
from workflow_gps.knowledge import TraceStore
from workflow_gps.orchestrator.patchers import (
    PATCH_PURPOSE,
    PATCH_SYSTEM_PROMPT,
    DefaultValuePatcher,
    GatewayValuePatcher,
...
from workflow_gps.skills import ActionsBody, NodeContract
from workflow_gps.skills.contract import SubgraphBody, ValueInput
from workflow_gps.skills.inputs import (
    bind_inputs,
    inputs_manifest,
    resolve_values,
    validate_value,
...
def test_template_holes_and_declared_inputs_agree_exactly():
    from workflow_gps.skills.inputs import _HOLE_RE
...
from workflow_gps.domains.cad import rect_plate_with_hole, write_binary_stl
