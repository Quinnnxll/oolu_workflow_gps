...
const STRINGS: Record<string, Entry> = {
  ...
  "press.bodyPh": {
    en: "What happened? Write it as you saw it.",
    zh: "发生了什么？照你看到的写下来。",
    es: "¿Qué pasó? Escríbelo como lo viste.",
    fr: "Que s'est-il passé ? Écrivez-le comme vous l'avez vu.",
  },
  "press.attach": {
    en: "Attach from Files",
    zh: "从文件附加",
  ...
  "press.consent": {
    ...
    zh: "我已阅读许可条款，同意据此发布",
    es: "He leído la licencia y consiento publicar bajo ella",
    fr: "J'ai lu la licence et je consens à publier sous ses termes",
  },
  "press.publish": {
    en: "Publish",
    zh: "发布",
  ...
  "press.empty": {
    en: "Nothing published yet — write the first piece.",
    zh: "还没有投稿——来写第一篇吧。",
    es: "Aún no hay nada publicado: escribe la primera pieza.",
    fr: "Rien de publié pour l'instant — écrivez le premier article.",
  },
