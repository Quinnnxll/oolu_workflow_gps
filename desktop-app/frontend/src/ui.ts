...
const STRINGS: Record<string, Entry> = {
  ...
  // The press (A1): the contribution shelf and the contribute form.
  "press.contributions": {
    en: "Contributions",
    zh: "投稿",
    es: "Contribuciones",
  ...
  "press.retold": {
    en: "retells an earlier piece",
    zh: "与较早的投稿相似",
    es: "reelabora una pieza anterior",
    fr: "reprend un article antérieur",
  },
  "press.empty": {
    en: "Nothing published yet — send News your story, photo, or clip below and it reviews it with you.",
    zh: "还没有投稿——把你的报道、照片或视频发给 News，它会与你一起审阅。",
    es: "Aún no hay nada publicado: envía a News tu historia, foto o vídeo abajo y lo revisará contigo.",
    fr: "Rien de publié pour l'instant — envoyez à News votre article, photo ou vidéo ci-dessous et il le relira avec vous.",
  },
  // The newsroom (A2): stories, the edition, and honest taps.
  "press.stories": {
    en: "Stories",
    zh: "报道",
    es: "Historias",
  ...
  "press.yours": {
    en: "ranked for you",
    zh: "为你排序",
    es: "ordenadas para ti",
    fr: "classés pour vous",
  },
  "press.compose": {
    en: "Compose now",
    zh: "现在编稿",
    es: "Componer ahora",
    fr: "Composer maintenant",
  },
  "press.editionOn": {
    en: "Morning edition ✓",
    zh: "晨间版 ✓",
  ...
  "press.editionHint": {
    en: "Deliver my edition to this thread every morning.",
    zh: "每天早上把我的版面送到这个会话。",
    es: "Entregar mi edición en este hilo cada mañana.",
    fr: "Livrer mon édition dans ce fil chaque matin.",
  },
  "press.noStories": {
    en: "No stories yet — contributions compose into stories.",
    zh: "还没有报道——投稿会被编成报道。",
    es: "Aún no hay historias: las contribuciones se componen en historias.",
    fr: "Pas encore d'articles — les contributions deviennent des articles.",
  },
  "press.like": {
    en: "Like",
    zh: "喜欢",
  ...
  "press.notRecorded": {
    en: "not recorded — personalization is off",
    zh: "未记录——个性化未开启",
  ...
  "ads.consentBody": {
    en: "The privacy policy changed (version 3): clearly labeled sponsored placements may appear on News, matched inside the platform, with revenue shared back to contributors. Personal data is never sold or given to advertisers. Nothing shows until you accept — declining costs you nothing but the ads.",
    zh: "隐私政策已更新（第 3 版）：News 可能出现明确标注的赞助内容，匹配在平台内部完成，收入与投稿者分享。个人数据绝不出售或提供给广告主。你接受之前不会显示任何广告——拒绝也不会失去任何功能。",
    es: "La política de privacidad cambió (versión 3): pueden aparecer contenidos patrocinados claramente etiquetados en News, emparejados dentro de la plataforma, con ingresos compartidos con quienes contribuyen. Los datos personales nunca se venden ni se entregan a los anunciantes. No se muestra nada hasta que aceptes; rechazar solo te cuesta los anuncios.",
    fr: "La politique de confidentialité a changé (version 3) : des contenus sponsorisés clairement étiquetés peuvent apparaître sur News, appariés au sein de la plateforme, avec des revenus partagés avec les contributeurs. Les données personnelles ne sont jamais vendues ni transmises aux annonceurs. Rien ne s'affiche avant votre accord — refuser ne vous coûte que les publicités.",
  },
  "ads.readPolicy": {
    en: "Read the policy",
    zh: "阅读政策",
  ...
  "ads.accept": {
    en: "Accept version 3",
    zh: "接受第 3 版",
    es: "Aceptar la versión 3",
    fr: "Accepter la version 3",
  },
  "ads.offer": {
    en: "View the offer",
    zh: "查看优惠",
  ...
  "explorer.heading": {
    en: "Compare, then the best buy",
    zh: "先比较，再选最值",
    es: "Compara y elige la mejor compra",
    fr: "Comparer, puis le meilleur achat",
  },
  "explorer.categoryPh": {
    en: "Category (empty = everything) — Enter to compare",
    zh: "类别（留空=全部）——回车开始比较",
    es: "Categoría (vacío = todo) — Intro para comparar",
    fr: "Catégorie (vide = tout) — Entrée pour comparer",
  },
  "explorer.follow": {
    en: "Follow this",
    zh: "关注",
  ...
  "explorer.followHint": {
    en: "Deliver this brief to this thread every morning.",
    zh: "每天早上把这份简报送到这个会话。",
    es: "Entregar este informe en este hilo cada mañana.",
    fr: "Livrer ce brief dans ce fil chaque matin.",
  },
  "explorer.winner": {
    en: "Best buy",
    zh: "最值之选",
  ...
  "explorer.why": {
    en: "Why this pick",
    zh: "为什么选它",
    es: "Por qué esta elección",
    fr: "Pourquoi ce choix",
  },
  "explorer.reviews": {
    en: "{n} verified reviews",
    zh: "{n} 条验证评价",
    es: "{n} reseñas verificadas",
    fr: "{n} avis vérifiés",
  },
  "explorer.trust": {
    en: "trust",
  ...
  "explorer.lab": {
    en: "{n} lab reports",
    zh: "{n} 份实测",
    es: "{n} informes de laboratorio",
    fr: "{n} rapports de labo",
  },
  "explorer.mode.value": {
    en: "Value",
    zh: "性价比",
  ...
  "explorer.mode.balanced": {
    en: "Balanced",
    zh: "均衡",
    es: "Equilibrado",
    fr: "Équilibré",
  },
  "explorer.mode.proven": {
    en: "Proven",
    zh: "口碑",
    es: "Probado",
    fr: "Éprouvé",
  },
  "explorer.mode.measured": {
    en: "Measured",
    zh: "实测",
    es: "Medido",
    fr: "Mesuré",
  ...
  // The travel desk (A7).
  "travel.heading": {
    en: "Plan a trip — time, people, budget",
    zh: "计划旅行——时间、人、预算",
    es: "Planear un viaje: tiempo, gente, presupuesto",
    fr: "Planifier un voyage — temps, personnes, budget",
  },
  "travel.from": {
    en: "From",
    zh: "从",
  ...
  "travel.partyPh": {
    en: "Party (usernames, comma-separated)",
    zh: "同行者（用户名，逗号分隔）",
    es: "Grupo (usuarios, separados por comas)",
    fr: "Groupe (identifiants, séparés par des virgules)",
  },
  "travel.budget": {
    en: "Budget",
    zh: "预算",
  ...
  "travel.noSupply": {
    en: "No travel packages on the shelf yet.",
    zh: "货架上还没有旅行套餐。",
    es: "Aún no hay paquetes de viaje.",
    fr: "Pas encore de forfaits voyage.",
  },
  "travel.calendar": {
    en: "My calendar",
    zh: "我的日历",
...
const ZH_HANT: Record<string, string> = {
  ...
  "press.contributions": "投稿",
  "press.upload": "新增照片、影片或音訊",
  "press.detach": "移除附件",
  "press.unpublish": "撤下",
  "press.retold": "與較早的投稿相似",
  "press.empty": "還沒有投稿——把你的報道、照片或影片發給 News，它會與你一起審閱。",
  "press.stories": "報導",
  "press.yours": "為你排序",
  "press.compose": "現在編稿",
  "press.editionOn": "晨間版 ✓",
  "press.editionOff": "晨間版",
  "press.editionHint": "每天早上把我的版面送到這個會話。",
  "press.noStories": "還沒有報導——投稿會被編成報導。",
  "press.like": "喜歡",
  "press.skip": "略過",
  "press.noted": "已記錄",
  ...
  "ads.accept": "接受第 3 版",
  "ads.offer": "查看優惠",
  "explorer.heading": "先比較，再選最值",
  "explorer.categoryPh": "類別（留空=全部）——按 Enter 開始比較",
  "explorer.follow": "關注",
  "explorer.following": "已關注 ✓",
  "explorer.followHint": "每天早上把這份簡報送到這個會話。",
  "explorer.winner": "最值之選",
  "explorer.score": "得分",
  "explorer.why": "為什麼選它",
  "explorer.reviews": "{n} 條驗證評價",
  "explorer.trust": "信任",
  "explorer.lab": "{n} 份實測",
  "explorer.mode.value": "性價比",
  "explorer.mode.balanced": "均衡",
  "explorer.mode.proven": "口碑",
  "explorer.mode.measured": "實測",
  "travel.heading": "計劃旅行——時間、人、預算",
  "travel.from": "從",
  "travel.to": "到",
  "travel.nights": "晚數",
  "travel.partyPh": "同行者（使用者名稱，逗號分隔）",
  "travel.budget": "預算",
  "travel.plan": "規劃",
  "travel.noSupply": "貨架上還沒有旅行套餐。",
  "travel.calendar": "我的日曆",
  "travel.eventPh": "事件標題",
  "travel.eventDay": "日期",
  "travel.addEvent": "添加",
  "travel.remove": "刪除",
