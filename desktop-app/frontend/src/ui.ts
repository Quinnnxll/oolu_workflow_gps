...
const STRINGS: Record<string, Entry> = {
  ...
  "friends.setPassword": {
    en: "Set a sign-in password",
    zh: "设置登录密码",
    es: "Establecer una contraseña",
    fr: "Définir un mot de passe",
  },
  "friends.setPasswordDesc": {
    en: "If you arrived through Google, set a password here so username + password works next time too.",
    zh: "如果你是通过 Google 登录的，在此设置密码，下次也能用用户名+密码登录。",
    es: "Si entraste con Google, establece una contraseña aquí para que usuario + contraseña también funcione la próxima vez.",
    fr: "Si vous êtes arrivé via Google, définissez un mot de passe ici pour que identifiant + mot de passe fonctionne aussi la prochaine fois.",
  },
  "friends.passwordSet": {
