...
``build_workflow_gps(settings)`` is the one-call factory: it selects and constructs
the backend + gateway from config and returns a ready ``WorkflowGPS``. Tests inject
...
ENV_API_BASE = "WFGPS_API_BASE"
ENV_FAST_MODEL = "WFGPS_FAST_MODEL"
ENV_REASONING_MODEL = "WFGPS_REASONING_MODEL"
ENV_BACKEND = "WFGPS_BACKEND"
ENV_PINNED_INDEX_URL = "WFGPS_PINNED_INDEX_URL"
ENV_UV_CACHE_DIR = "WFGPS_UV_CACHE_DIR"
...
class BackendSettings(BaseModel):
    ...
    image: str = "workflow-gps-sandbox:latest"
